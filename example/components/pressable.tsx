...
import { Platform, Pressable, PressableProps, StyleSheet, StyleProp, ViewStyle } from 'react-native';
...
const MyPressable: FC<PropsWithChildren<Props>> = ({
  ...
  return (
    <Pressable
      ...
      style={({ pressed }) => [styles.base, { opacity: disabled ? 0.3 : 1 }, style, pressed && activeStyleMemo]}
    >
      {children}
    </Pressable>
  );
